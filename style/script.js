...
const fullText = ["I LOVE YOU, BHUNTI"];
const fontSize = 100;
...
function resizeCanvas() {
  ...
  bear.src = "https://i.pinimg.com/originals/e5/c5/4c/e5c54cd43fd75a7ec5b7cf0f65838ec3.gif";
...
function maybeRevealPhoto() {
  ...
  const allArrived = currentCharIndex >= targetDotsQueue.length &&
    dots.every(
      (dot) =>
        Math.abs(dot.targetX - dot.x) < 2 &&
        Math.abs(dot.targetY - dot.y) < 2
    );
